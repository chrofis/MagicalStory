...
- [ ] Decide whether an INTRODUCED brief fault should trigger a second review round — the re-check now reports it, nothing fixes it, and the page ships. Costs one text call per affected story. → docs/decisions.md 2026-08-25
