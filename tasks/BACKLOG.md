...
- [ ] landmark_index rows typed Castle but named after a river/village (#6652 Torneresse, #6536 Saint-Aubin FR, #6660 Villars-sous-Mont, #27275 Stein SG): retype; their held-back photos still need descriptions → scripts/admin/backfill-landmark-types.js
...
- [ ] 5 landmark photos cannot be copied to R2: corrupt source JPEGs on Commons (VipsJpeg "Invalid SOS parameters"), e.g. #12026_3 San Rocco (Tirano); replace the photos or drop the slots → scripts/admin/backfill-landmark-photos-to-r2.js
