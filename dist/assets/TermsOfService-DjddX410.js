...
• La Convention des Nations Unies sur les contrats de vente internationale de marchandises ne s'applique pas`},{title:"17. Contact",content:"Pour toute question concernant ces Conditions, veuillez nous contacter à : legal@magicalstory.com"}]}};function f(){const{language:t}=a(),s=l(),n=r[t]||r.en;return e.jsxs("div",{className:"min-h-screen bg-gray-50 flex flex-col",children:[e.jsx(u,{currentStep:0}),e.jsxs("div",{className:"flex-1 max-w-4xl mx-auto px-4 py-8",children:[e.jsxs("button",{onClick:()=>s(-1),className:"flex items-center gap-2 text-indigo-600 hover:text-indigo-800 mb-6",children:[e.jsx(c,{size:20}),t==="de"?"Zurück":t==="fr"?"Retour":"Back"]}),e.jsx("h1",{className:"text-3xl font-bold text-gray-900 mb-2",children:n.title}),e.jsx("p",{className:"text-gray-500 mb-8",children:n.lastUpdated}),e.jsx("div",{className:"bg-white rounded-xl shadow-sm p-6 md:p-8 space-y-8",children:n.sections.map((i,o)=>e.jsxs("section",{children:[e.jsx("h2",{className:"text-xl font-semibold text-gray-800 mb-3",children:i.title}),e.jsx("div",{className:"text-gray-600 whitespace-pre-line",children:i.content})]},o))})]})]})}export{f as default};
