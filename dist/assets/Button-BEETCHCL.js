import{j as e}from"./index-CQcWBoF_.js";const x={primary:"bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg hover:shadow-xl",secondary:"bg-indigo-100 text-indigo-700 hover:bg-indigo-200",outline:"border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50",ghost:"text-indigo-600 hover:bg-indigo-50",danger:"bg-red-600 text-white hover:bg-red-700"},c={sm:"px-3 py-1.5 text-sm",md:"px-4 py-2 text-base",lg:"px-6 py-3 text-lg"};function h({variant:o="primary",size:t="md",icon:s,iconPosition:r="left",loading:i=!1,disabled:a,className:n="",children:l,...d}){const g=a||i;return e.jsxs("button",{className:`
