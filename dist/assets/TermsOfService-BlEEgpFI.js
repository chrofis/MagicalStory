import{u as l,j as e}from"./index-Dwn1duX9.js";import{u}from"./vendor-react-DeDwXAjR.js";import{N as c}from"./Textarea-l3z1NiDb.js";import"./Input-CsyqxRSv.js";import{A as d}from"./arrow-left-B9rCf5qf.js";import"./vendor-firebase-CO9kgU5s.js";import"./UserMenu-C1y7y6lE.js";import"./key-round-DBA03P_F.js";import"./sparkles-93JrAAM1.js";import"./book-open-npobYVdJ.js";import"./mail-6_s_8Poe.js";import"./circle-x-C0eAwrfS.js";import"./clock-D08-2HcA.js";const s={en:{title:"Terms of Service",lastUpdated:"Last updated: January 2025",sections:[{title:"1. Acceptance of Terms",content:'By accessing and using Magical Story ("the Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.'},{title:"2. Service Availability and Eligibility",content:`IMPORTANT: This Service is intended exclusively for residents of Switzerland and the European Union.
...
• We reserve the right to terminate accounts and refuse service to anyone who misrepresents their residency or location`},{title:"3. Description of Service",content:"Magical Story is an AI-powered platform that creates personalized storybooks based on photos and character descriptions you provide. Photos are transformed into illustrated avatars that appear in your custom story."},{title:"4. User Responsibilities and Warranties",content:`By using the Service, you warrant and represent that:
...
• You will not use the Service for any unlawful purpose`},{title:"5. Prohibited Content and Acceptable Use",content:`The following content is strictly prohibited:
...
We reserve the right to refuse service, remove content, and terminate accounts that violate this policy without notice or refund.`},{title:"6. Intellectual Property",content:`• You retain all rights to the original photos you upload
...
• Our platform, technology, and branding remain our intellectual property`},{title:"7. Content Review and Final Responsibility",content:`IMPORTANT: You are the final publisher of your story.
...
• The platform is a tool; you are the publisher of the final work`},{title:"8. Copyright Claims and Takedowns",content:`We respect intellectual property rights and respond to valid infringement notices.
...
• Repeat infringers will have their accounts terminated`},{title:"9. Reporting Violations",content:`If you encounter content that violates these Terms or applicable laws:
...
• We may remove content and terminate accounts without prior notice`},{title:"10. Limitation of Liability",content:`TO THE MAXIMUM EXTENT PERMITTED BY LAW:
...
• We are not responsible for any claims arising from your misuse of the Service or violation of these terms`},{title:"11. Indemnification",content:`You agree to indemnify, defend, and hold harmless Magical Story, its officers, directors, employees, and agents from any claims, damages, losses, or expenses (including legal fees) arising from:

• Your use of the Service
• Your violation of these Terms
• Your violation of any third-party rights
• Content you upload or create using the Service`},{title:"12. Data Processing",content:`• Photos are processed using AI technology to create avatar illustrations
...
• See our Privacy Policy for complete details on data handling`},{title:"13. Age Requirements",content:`• You must be at least 18 years old to create an account
...
• Wir behalten uns das Recht vor, Konten zu kündigen und Personen, die ihren Wohnsitz oder Standort falsch angeben, den Dienst zu verweigern`},{title:"3. Beschreibung des Dienstes",content:"Magical Story ist eine KI-gestützte Plattform, die personalisierte Geschichtenbücher basierend auf von Ihnen bereitgestellten Fotos und Charakterbeschreibungen erstellt. Fotos werden in illustrierte Avatare umgewandelt, die in Ihrer individuellen Geschichte erscheinen."},{title:"4. Verantwortlichkeiten und Zusicherungen des Nutzers",content:`Durch die Nutzung des Dienstes garantieren und versichern Sie, dass:
...
• Sie den Dienst nicht für rechtswidrige Zwecke nutzen werden`},{title:"5. Verbotene Inhalte und Nutzungsbedingungen",content:`Folgende Inhalte sind streng verboten:
...
• Unsere Plattform, Technologie und Marke bleiben unser geistiges Eigentum`},{title:"7. Inhaltsprüfung und Endverantwortung",content:`WICHTIG: Sie sind der endgültige Herausgeber Ihrer Geschichte.
...
• Die Plattform ist ein Werkzeug; Sie sind der Herausgeber des endgültigen Werks`},{title:"8. Urheberrechtsansprüche und Löschung",content:`Wir respektieren geistige Eigentumsrechte und reagieren auf gültige Verletzungsanzeigen.
...
• Nous nous réservons le droit de résilier les comptes et de refuser le service à toute personne qui falsifie sa résidence ou son emplacement`},{title:"3. Description du Service",content:"Magical Story est une plateforme alimentée par l'IA qui crée des livres d'histoires personnalisés basés sur les photos et descriptions de personnages que vous fournissez. Les photos sont transformées en avatars illustrés qui apparaissent dans votre histoire personnalisée."},{title:"4. Responsabilités et Garanties de l'Utilisateur",content:`En utilisant le Service, vous garantissez et déclarez que :
...
• Vous n'utiliserez pas le Service à des fins illégales`},{title:"5. Contenu Interdit et Utilisation Acceptable",content:`Les contenus suivants sont strictement interdits :
...
Nous nous réservons le droit de refuser le service, de supprimer le contenu et de résilier les comptes qui violent cette politique sans préavis ni remboursement.`},{title:"6. Propriété Intellectuelle",content:`• Vous conservez tous les droits sur les photos originales que vous téléchargez
...
• Notre plateforme, technologie et marque restent notre propriété intellectuelle`},{title:"7. Révision du Contenu et Responsabilité Finale",content:`IMPORTANT : Vous êtes l'éditeur final de votre histoire.
...
• La plateforme est un outil ; vous êtes l'éditeur de l'œuvre finale`},{title:"8. Réclamations de Droits d'Auteur et Suppression",content:`Nous respectons les droits de propriété intellectuelle et répondons aux avis de violation valides.
...
• Les contrevenants récidivistes verront leurs comptes résiliés`},{title:"9. Signalement des Violations",content:`Si vous rencontrez un contenu qui viole ces Conditions ou les lois applicables :
...
• Nous pouvons supprimer le contenu et résilier les comptes sans préavis`},{title:"10. Limitation de Responsabilité",content:`DANS LA MESURE MAXIMALE PERMISE PAR LA LOI :
...
• Nous ne sommes pas responsables des réclamations découlant de votre mauvaise utilisation du Service ou de la violation de ces conditions`},{title:"11. Indemnisation",content:`Vous acceptez d'indemniser, de défendre et de dégager de toute responsabilité Magical Story, ses dirigeants, directeurs, employés et agents contre toute réclamation, dommage, perte ou dépense (y compris les frais juridiques) découlant de :

• Votre utilisation du Service
• Votre violation de ces Conditions
• Votre violation des droits de tiers
• Le contenu que vous téléchargez ou créez en utilisant le Service`},{title:"12. Traitement des Données",content:`• Les photos sont traitées à l'aide de la technologie IA pour créer des illustrations d'avatar
...
• Consultez notre Politique de Confidentialité pour les détails complets sur le traitement des données`},{title:"13. Conditions d'Âge",content:`• Vous devez avoir au moins 18 ans pour créer un compte
• Les parents/tuteurs peuvent créer des histoires mettant en scène leurs enfants mineurs
• En téléchargeant des photos de mineurs, vous confirmez avoir l'autorité parentale ou le consentement explicite`},{title:"14. Modifications des Conditions",content:"Nous nous réservons le droit de modifier ces Conditions à tout moment. L'utilisation continue du Service après les modifications constitue l'acceptation des nouvelles conditions. Nous informerons les utilisateurs des changements importants par e-mail ou notification sur la plateforme."},{title:"15. Résiliation",content:"Nous pouvons résilier ou suspendre votre compte à tout moment en cas de violation de ces Conditions. À la résiliation, votre droit d'utiliser le Service cesse immédiatement."},{title:"16. Droit Applicable et Juridiction",content:`• Ces Conditions sont régies exclusivement par les lois de la Suisse
...
• La Convention des Nations Unies sur les contrats de vente internationale de marchandises ne s'applique pas`},{title:"17. Contact",content:"Pour toute question concernant ces Conditions, veuillez nous contacter à : legal@magicalstory.ch"}]}};function k(){const{language:t}=l(),i=u(),n=s[t]||s.en,o=()=>{window.history.length>1?i(-1):i("/")};return e.jsxs("div",{className:"min-h-screen bg-gray-50 flex flex-col",children:[e.jsx(c,{currentStep:0}),e.jsxs("div",{className:"flex-1 max-w-4xl mx-auto px-4 py-8",children:[e.jsxs("button",{onClick:o,className:"flex items-center gap-2 text-indigo-600 hover:text-indigo-800 mb-6",children:[e.jsx(d,{size:20}),t==="de"?"Zurück":t==="fr"?"Retour":"Back"]}),e.jsx("h1",{className:"text-3xl font-bold text-gray-900 mb-2",children:n.title}),e.jsx("p",{className:"text-gray-500 mb-8",children:n.lastUpdated}),e.jsx("div",{className:"bg-white rounded-2xl shadow-sm p-6 md:p-8 space-y-8",children:n.sections.map((r,a)=>e.jsxs("section",{children:[e.jsx("h2",{className:"text-xl font-semibold text-gray-800 mb-3",children:r.title}),e.jsx("div",{className:"text-gray-600 whitespace-pre-line",children:r.content})]},a))})]})]})}export{k as default};
