...
const THEMES = {
  ...
  'life-challenges': {
    ...
    'staying-hospital': { en: 'Staying in Hospital', de: 'Im Spital', fr: "Séjour à l'hôpital", it: "Un Ricovero in Ospedale" },
    ...
    'going-vacation': { en: 'Going on Vacation', de: 'In die Ferien fahren', fr: 'Partir en vacances', it: 'Andare in Vacanza' },
