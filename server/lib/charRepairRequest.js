...
const CHAR_REPAIR_REQUEST_KEYS = Object.freeze([
  ...
  'defectTypes',           // the finding's structured type(s) — the prompt's fixed defect phrase (faceRepair CHAR_FIX_DEFECT_PHRASES) and, with no whiteoutTarget, face vs full figure (resolveRepairAxes)
