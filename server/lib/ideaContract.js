...
CONTRACT CHECK, written in the review and never in the idea itself: quote each of the five slots from the corrected idea, one line each, and name which slot it is. A slot with nothing to quote is added to the final. Then quote any sentence that says what the one that resists finally does, and cut it. List every cut sentence, not one of them.`;
