...
function buildTextZoneInstruction(textPosition, textZoneDescription, areaPct) {
  ...
  return `**COMPOSITION — CALM ZONE:** The ${corner} of the image (roughly ${areaPct}) is reserved for white text overlay. Render the SURFACE in that region as: ${surface} — gentle gradient, minimal texture, low contrast, saturated colour preferred (deep blue, dark green, rich brown, saturated cobblestone). Keep this region free of: signage, labels, props, busy patterns, sharp visual breaks, pure-black or pure-white fill, flat panels or coloured blocks or rectangles or framed strips. CHARACTERS may extend into the calm region with feet, lower legs, or a sliver of body — that is FINE; the text overlay sits in front of the scene and a calm surface remains calm enough to read white text against. NEVER crop or cut off a character at the calm-zone boundary to keep them out of it: a full-body character with feet on the calm surface is correct; a floating headless torso, a head-only figure, or a body that ends abruptly at the zone edge is WRONG. If a layout reference image is attached, the slightly darker grey region marks the calm zone — paint that area as continuous scene material (sky, wall, water, foliage, ground), not as a separate panel.`;
}
...
const ART_STYLES = {
  ...
  pixar: 'A 3D animated children\'s illustration in the style of Pixar and Disney Animation Studios. Stylized cartoon characters with smooth skin and simplified features. Vibrant colors, soft volumetric lighting, and a warm family-friendly aesthetic. Not photorealistic. Faces: smooth stylized skin with no pores, expressive eyes with visible iris reflections, features and bone structure age-appropriate to each character. Consistent 3D-rendered look across all characters. Preserve each character\'s actual age: babies, kindergartners, teenagers, adults, and grandparents each look their real age in this style.',
  ...
  steampunk: {
    default: 'A steampunk graphic novel illustration with Victorian aesthetic. Intricate gears, brass and copper mechanisms, leather textures, and a sepia-toned muted color palette with detailed linework. Not photorealistic. Faces: realistic proportions, defined features, natural eyes with warm lighting. Never cartoonish or anime-styled — maintain grounded realism. Preserve each character\'s actual age: babies, kindergartners, teenagers, adults, and grandparents each look their real age in this style.',
  ...
  comic: 'A classic American comic book illustration in the style of Jack Kirby and Jim Lee. Heavy black ink lines, dynamic composition, visible halftone dots, and vibrant CMYK colors. Not photorealistic. Faces: inked outlines, halftone-style shading, bold features, dramatic expressions. Classic Western comic book rendering. Preserve each character\'s actual age: babies, kindergartners, teenagers, adults, and grandparents each look their real age in this style.',
