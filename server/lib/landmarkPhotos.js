...
async function findBestLandmarkImage(landmarkName, landmarkType, lang = null, pageId = null, qid = null, region = null, country = 'Switzerland') {
  ...
  const isNotUsefulPhoto = (desc) => /\b(engraving|illustration|drawing|sketch|painting|artwork|lithograph|woodcut|etching|historical artwork|historical map|coat of arms|heraldry|painted coat|layout of|floor plan|architectural plan|shows a wooden door|shows a door|shows an old door|detail of a|close-up of a|closeup of a|museum exhibit|display case|window display|shows a spoon|shows a sign|stone tablet|archaeological dig|statue.*bronze|bronze statue|golden statue|shows tools|shows documents)\b/i.test(desc || '');
  ...
  try {
    await pool.query(`
      INSERT INTO landmark_index (
        ...
        photo_url, photo_attribution, photo_source, photo_description, photo_type,
        photo_url_2, photo_attribution_2, photo_description_2, photo_type_2,
        photo_url_3, photo_attribution_3, photo_description_3, photo_type_3,
        photo_url_4, photo_attribution_4, photo_description_4, photo_type_4,
        photo_url_5, photo_attribution_5, photo_description_5, photo_type_5,
        photo_url_6, photo_attribution_6, photo_description_6, photo_type_6,
        wikipedia_extract,
      ...
      ON CONFLICT (wikidata_qid) DO UPDATE SET
        ...
        photo_type = COALESCE(EXCLUDED.photo_type, landmark_index.photo_type),
        ...
        photo_type_2 = COALESCE(EXCLUDED.photo_type_2, landmark_index.photo_type_2),
        ...
        photo_type_3 = COALESCE(EXCLUDED.photo_type_3, landmark_index.photo_type_3),
        ...
        photo_type_4 = COALESCE(EXCLUDED.photo_type_4, landmark_index.photo_type_4),
        ...
        photo_type_5 = COALESCE(EXCLUDED.photo_type_5, landmark_index.photo_type_5),
        ...
        photo_type_6 = COALESCE(EXCLUDED.photo_type_6, landmark_index.photo_type_6),
