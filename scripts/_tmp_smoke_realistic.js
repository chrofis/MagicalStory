...
(async () => {
  ...
  console.log('3. Create story job (5 pages, REALISTIC, snowy adventure)…');
  const inputs = {
    pages: 5,
    language: 'de',
    languageLevel: 'standard',
    storyCategory: 'adventure',
    storyTopic: 'treasure-hunt',
    storyTheme: 'treasure-hunt',
    artStyle: 'realistic',
    storyDetails: 'Eine winterliche Schneewanderung in den verschneiten Bergen mit einer Schatzsuche im Schnee.',
    characters: arr,
