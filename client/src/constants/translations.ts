...
export const translations: Record<'en' | 'de' | 'fr' | 'it', TranslationStrings> = {
  en: {
    ...
    heroSubtitle: '',
    heroDescription: 'A personalized children\'s book where your child is the hero. Upload a photo, pick a theme, create your first story free.',
    bookText: 'Also available as a printed book from CHF 29. A personal gift they will want to read again and again.',
    startJourney: 'Create a Free Story',
    ...
    firstGradeDesc: 'Ages: 3-6\nLanguage: simple vocabulary, short sentences\nRecommended pages: 10-15\nIdeal for: 1-2 characters, simple stories',
    standard: 'Chapter Book',
    standardDesc: 'Ages: 6-10\nLanguage: accessible vocabulary, normal sentences\nRecommended pages: 15-20\nIdeal for: 2-4 characters',
    advanced: 'Young Reader',
    advancedDesc: 'Ages: 10+\nLanguage: rich vocabulary, complex sentences\nRecommended pages: 20-25\nIdeal for: many characters, complex storylines\nLayout: square image with text below (no overlay)',
  ...
  de: {
    ...
    heroSubtitle: '',
    heroDescription: 'Ein personalisiertes Kinderbuch, in dem dein Kind der Held ist. Foto hochladen, Thema wählen, erste Geschichte gratis erstellen.',
    bookText: 'Auch als gedrucktes Buch ab CHF 29 bestellbar. Ein persönliches Geschenk, das immer wieder gelesen wird.',
    startJourney: 'Gratis Geschichte erstellen',
    ...
    uploadPhotoFirst: 'Bitte lade ein Foto hoch, um fortzufahren',
    photoGoodExamples: 'Gut: Ganzkörper oder Oberkörper',
    photoBadExamples: 'Vermeiden: Nur Gesicht, Sonnenbrille, Hüte, Helme, unscharf',
    noFaceDetected: 'Kein Gesicht im Foto erkannt. Bitte lade ein klares Foto mit einem sichtbaren Gesicht hoch.',
    ...
    firstGradeDesc: 'Alter: 3-6\nSprache: einfacher Wortschatz, kurze Sätze\nEmpfohlene Seiten: 10-15\nIdeal für: 1-2 Figuren, einfache Geschichten',
    standard: 'Kinderbuch',
    standardDesc: 'Alter: 6-10\nSprache: verständlicher Wortschatz, normale Sätze\nEmpfohlene Seiten: 15-20\nIdeal für: 2-4 Figuren',
    advanced: 'Jugendbuch',
    advancedDesc: 'Alter: 10+\nSprache: reicher Wortschatz, komplexe Sätze\nEmpfohlene Seiten: 20-25\nIdeal für: viele Figuren, komplexe Handlung\nLayout: quadratisches Bild mit Text darunter (kein Overlay)',
    ...
    apiKeyNote: 'Dein API-Schlüssel wird lokal im Browser gespeichert.',
    ...
    outlineReady: 'Geschichten-Gliederung',
    editOutline: 'Du kannst die Gliederung unten bearbeiten, bevor du die vollständige Geschichte erstellst:',
    ...
    uploadStoryDesc: 'Lade eine vorhandene Textdatei hoch, um Szenenbeschreibungen zu generieren',
    ...
    geminiApiKeyPrompt: 'Gib deinen Google Gemini API-Schlüssel ein:',
    geminiApiKeyNote: 'Hol dir deinen Schlüssel von Google AI Studio',
  ...
  fr: {
    ...
    heroSubtitle: '',
    heroDescription: 'Un livre pour enfant personnalisé où votre enfant est le héros. Téléchargez une photo, choisissez un thème, créez votre première histoire gratuitement.',
    bookText: 'Aussi disponible en livre imprimé dès CHF 29. Un cadeau personnalisé à relire encore et encore.',
    startJourney: 'Créer une histoire gratuite',
    ...
    firstGrade: 'Album Illustré',
    firstGradeDesc: 'Âge: 3-6\nLangue: vocabulaire simple, phrases courtes\nPages recommandées: 10-15\nIdéal pour: 1-2 personnages, histoires simples',
    standard: 'Livre Enfant',
    standardDesc: 'Âge: 6-10\nLangue: vocabulaire accessible, phrases normales\nPages recommandées: 15-20\nIdéal pour: 2-4 personnages',
    advanced: 'Roman Jeunesse',
    advancedDesc: 'Âge: 10+\nLangue: vocabulaire riche, phrases complexes\nPages recommandées: 20-25\nIdéal pour: plusieurs personnages, intrigues complexes\nMise en page: image carrée avec texte en dessous (sans superposition)',
  ...
  it: {
    ...
    heroSubtitle: '',
    heroDescription: 'Un libro per bambini personalizzato in cui tuo figlio è il protagonista. Carica una foto, scegli un tema, crea la tua prima storia gratis.',
    bookText: 'Disponibile anche come libro stampato da CHF 29. Un regalo personale da rileggere ancora e ancora.',
    startJourney: 'Crea una storia gratuita',
    ...
    resetLinkSent: 'Email di reimpostazione inviata! Controlla la tua casella di posta.',
    backToLogin: 'Torna all\'accesso',
    chooseStoryType: 'Scegli il tipo di storia',
    chooseArtStyle: 'Scegli lo stile artistico',
    artStyleDescription: 'Seleziona lo stile visivo per la tua storia',
    addCustomStoryType: 'Aggiungi un tipo di storia personalizzato',
    storyTypeName: 'Nome del tipo di storia',
    storyTypeEmoji: 'Emoji',
    addStoryType: 'Aggiungi',
    createCharacters: 'Crea i tuoi personaggi',
    charactersStepTitle: 'Personaggi e ruoli',
    characterCreated: 'Personaggio creato!',
    createAnother: 'Crea un altro personaggio',
    continueToRelationships: 'Continua con le relazioni',
    yourCharacters: 'I tuoi personaggi:',
    startCreating: 'Inizia a creare un personaggio',
    characterName: 'Nome del personaggio',
    characterPhoto: 'Foto del personaggio',
    uploadPhoto: 'Carica una foto',
    uploadPhotoFirst: 'Carica una foto per continuare',
    photoGoodExamples: 'Bene: corpo intero o busto',
    photoBadExamples: 'Evita: solo viso, occhiali da sole, cappelli, caschi, foto sfocate',
    noFaceDetected: 'Nessun volto rilevato nella foto. Carica una foto nitida che mostri un viso.',
    orDescribe: 'OPPURE descrivi il personaggio',
    characterAge: 'Età',
    hairColor: 'Colore dei capelli',
    otherFeatures: 'Altre caratteristiche',
    descriptionPlaceholder: 'es. Occhi azzurri, porta gli occhiali, ha le lentiggini',
    gender: 'Genere',
    male: 'Maschio',
    female: 'Femmina',
    other: 'Sconosciuto',
    ...
    addCustomFears: 'Aggiungi paure personalizzate',
    specialDetails: 'Hobby, interessi, peluche preferito, professione e altri dettagli',
    specialDetailsPlaceholder: 'es. Ama dipingere, adora i dinosauri, il suo orsetto preferito si chiama Bruno, vuole fare il pompiere',
    fears: 'Paure',
    addCustomRelationship: 'Aggiungi una relazione personalizzata',
    cancel: 'Annulla',
    saveCharacter: 'Salva personaggio',
    editCharacter: 'Modifica',
    deleteCharacter: 'Elimina',
    defineRelationships: 'Definisci le relazioni tra personaggi',
    defineRelationshipsDesc: 'Definisci come ogni personaggio è legato agli altri.',
    is: 'è',
    reverseRelationship: 'Relazione inversa:',
    storySettings: 'Impostazioni della storia',
    selectMainCharacters: 'Seleziona i personaggi principali (max 2)',
    numberOfPages: 'Numero di pagine',
    readingLevel: 'Livello di lettura',
    firstGrade: 'Libro illustrato',
    firstGradeDesc: 'Età: 3-6\nLingua: vocabolario semplice, frasi brevi\nPagine consigliate: 10-15\nIdeale per: 1-2 personaggi, storie semplici',
    standard: 'Libro per bambini',
    standardDesc: 'Età: 6-10\nLingua: vocabolario accessibile, frasi normali\nPagine consigliate: 15-20\nIdeale per: 2-4 personaggi',
    advanced: 'Libro per ragazzi',
    advancedDesc: 'Età: 10+\nLingua: vocabolario ricco, frasi complesse\nPagine consigliate: 20-25\nIdeale per: molti personaggi, trame complesse\nLayout: immagine quadrata con testo sotto (senza sovrapposizione)',
    generateStory: 'Genera la storia!',
    creating: 'Sto creando la tua storia...',
    storyReady: 'La tua storia è pronta!',
    downloadTXT: 'Scarica in TXT',
    downloadPDF: 'Scarica in PDF',
    downloadPrompt: 'Scarica il prompt',
    viewPrompt: 'Mostra il prompt',
    hidePrompt: 'Nascondi il prompt',
    promptUsed: 'Prompt usato per generare la storia:',
    createAnotherStory: 'Crea un\'altra storia',
    back: 'Indietro',
    next: 'Avanti',
    exportConfig: 'Esporta configurazione',
    exportStoryInfo: 'Esporta informazioni storia (MD)',
    importConfig: 'Importa configurazione',
    charactersCreated: 'Hai creato {count} personagg{s} finora.',
    mainCharacter: 'Personaggio principale',
    apiKeyRequired: 'Chiave API richiesta',
    apiKeyPrompt: 'Inserisci la tua chiave API Anthropic per generare le storie:',
    apiKeyPlaceholder: 'sk-ant-...',
    saveApiKey: 'Salva chiave API',
    apiKeyNote: 'La tua chiave API è salvata localmente nel browser.',
    promptPreview: 'Anteprima del prompt',
    showPromptPreview: 'Mostra il prompt',
    hidePromptPreview: 'Nascondi il prompt',
    editPrompt: 'Modifica il prompt',
    resetPrompt: 'Ripristina predefinito',
    storyDetails: 'Trama / Dettagli della storia',
    storyDetailsOptional: '(facoltativo)',
    storyDetailsPlaceholder: 'es. Luogo: foresta incantata, Elementi speciali: animali magici parlanti, Epoca: Medioevo...',
    generateOutline: 'Genera la scaletta',
    generatingOutline: 'Generazione della scaletta...',
    outlineReady: 'Scaletta della storia',
    editOutline: 'Puoi modificare la scaletta qui sotto prima di generare la storia completa:',
    regenerateOutline: 'Rigenera la scaletta',
    createScenes: 'Crea le descrizioni delle scene',
    creatingScenes: 'Sto creando le descrizioni delle scene...',
    scenesReady: 'Descrizioni delle scene',
    downloadScenes: 'Scarica le scene',
    sceneForPage: 'Scena per la pagina',
    yourStory: 'La tua storia',
    uploadStory: 'Carica una storia',
    uploadStoryDesc: 'Carica un file di testo esistente per generare le descrizioni delle scene',
    generateImages: 'Genera le immagini delle scene',
    generatingImages: 'Sto generando le immagini...',
    imagesReady: 'Immagini delle scene',
    downloadImage: 'Scarica l\'immagine',
    geminiApiKey: 'Chiave API Gemini',
    geminiApiKeyPrompt: 'Inserisci la tua chiave API Google Gemini per generare le immagini:',
    geminiApiKeyNote: 'Ottieni la tua chiave da Google AI Studio',
    imageForPage: 'Immagine per la pagina',
    generateAvatar: 'Genera avatar Pixar',
    generatingAvatar: 'Generazione dell\'avatar...',
    avatarGenerated: 'Avatar generato!',
    useGeneratedAvatar: 'Usa l\'avatar generato',
    keepOriginal: 'Mantieni la foto originale',
    uploadType: 'Che cosa stai caricando?',
    uploadRealPhoto: 'Foto reale (verrà generato un avatar)',
    uploadReadyAvatar: 'Avatar pronto (già stilizzato)',
    editStory: 'Modifica la storia',
    saveStory: 'Salva la storia',
    editScene: 'Modifica la scena',
    saveScene: 'Salva la scena',
    editImage: 'Modifica l\'immagine',
    regenerateImage: 'Rigenera l\'immagine',
    showEditPrompt: 'Mostra il prompt',
    hideEditPrompt: 'Nascondi il prompt',
    editInstruction: 'Cosa va cambiato?',
    ...
    failedGeneric: 'Si è verificato un errore. Riprova.',
    // Impersonation
    impersonationViewingAs: 'Visualizzato come',
    impersonationStopViewing: 'Termina visualizzazione',
    impersonationStopping: 'Sto terminando...',
