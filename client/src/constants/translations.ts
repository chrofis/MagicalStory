...
export const translations: Record<'en' | 'de' | 'fr', TranslationStrings> = {
  ...
  de: {
    ...
    specialDetails: 'Hobbys, Hoffnungen & Ängste, Lieblingstiere und andere Besonderheiten',
    specialDetailsPlaceholder: 'z.B. Malt gerne, träumt davon Astronaut zu werden, hat Angst vor Spinnen, liebt Pferde',
    fears: 'Ängste',
    ...
    advancedDesc: 'Längerer Text, Bild auf der gegenüberliegenden Seite',
  ...
  fr: {
    ...
    specialDetails: 'Loisirs, Espoirs & Peurs, Animaux Préférés et Autres Détails',
    specialDetailsPlaceholder: 'ex. Aime peindre, rêve de devenir astronaute, a peur des araignées, adore les chevaux',
    fears: 'Peurs',
