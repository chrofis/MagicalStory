...
export const translations: Record<'en' | 'de' | 'fr' | 'it', TranslationStrings> = {
  en: {
    ...
    heroSubtitle: '',
    heroDescription: 'Make your child the hero of their own story. Upload a photo, pick a theme, create your first story free.',
  ...
  de: {
    ...
    heroSubtitle: '',
    heroDescription: 'Mach dein Kind zum Helden seiner eigenen Geschichte. Foto hochladen, Thema wählen, erste Geschichte gratis erstellen.',
  ...
  fr: {
    ...
    heroSubtitle: '',
    heroDescription: 'Faites de votre enfant le héros de sa propre histoire. Téléchargez une photo, choisissez un thème, créez votre première histoire gratuitement.',
  ...
  it: {
    ...
    heroSubtitle: '',
    heroDescription: 'Rendi tuo figlio il protagonista della sua storia. Carica una foto, scegli un tema, crea la tua prima storia gratis.',
    bookText: 'Disponibile anche come libro stampato. Un regalo personale da rileggere ancora e ancora.',
