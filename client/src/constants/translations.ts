...
export const translations: Record<'en' | 'de' | 'fr', TranslationStrings> = {
  en: {
    ...
    standardDesc: 'Ages 6-10. Ideal for 2-3 characters, 20-30 pages. Normal sentences, accessible vocabulary.',
  ...
  de: {
    ...
    standard: 'Kinderbuch',
    standardDesc: 'Alter 6-10. Ideal für 2-3 Figuren, 20-30 Seiten. Normale Sätze, verständlicher Wortschatz.',
    advanced: 'Jugendbuch',
  ...
  fr: {
    ...
    firstGradeDesc: 'Âges 3-6. Mots simples, phrases courtes. Idéal pour 10-20 pages.',
    standard: 'Livre Enfant',
    standardDesc: 'Âges 6-10. Idéal pour 2-3 personnages, 20-30 pages. Phrases normales, vocabulaire accessible.',
    advanced: 'Roman Jeunesse',
    advancedDesc: 'Âges 10+. Intrigues complexes, vocabulaire riche. Idéal avec plusieurs personnages, 30-50 pages.',
