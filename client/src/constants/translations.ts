...
export const translations: Record<'en' | 'de' | 'fr', TranslationStrings> = {
  en: {
    ...
    bookText: 'Order as a printed book — a personalized keepsake they will want to read again and again.',
  ...
  de: {
    ...
    bookText: 'Als gedrucktes Buch bestellen — ein persönliches Geschenk, das immer wieder gelesen wird.',
  ...
  fr: {
    ...
    bookText: 'Commandez en livre imprimé — un cadeau personnalisé à relire encore et encore.',
