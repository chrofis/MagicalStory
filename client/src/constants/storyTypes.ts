...
export const lifeChallenges: LifeChallenge[] = [
  ...
  // Preschool (4-6 years)
  { id: 'cleaning-up', name: { en: 'Cleaning Up Toys', de: 'Aufräumen', fr: 'Ranger les jouets', it: 'Riordinare i giocattoli' }, emoji: '🧹', ageGroup: 'preschool', suitableAges: [2, 6] },
  { id: 'sitting-still', name: { en: 'Sitting Still', de: 'Still sitzen', fr: 'Rester tranquille', it: 'Stare fermi' }, emoji: '🪑', ageGroup: 'preschool', suitableAges: [3, 7] },
  ...
  { id: 'table-manners', name: { en: 'Table Manners', de: 'Tischmanieren', fr: 'Bonnes manières à table', it: 'Buone maniere a tavola' }, emoji: '🍴', ageGroup: 'preschool', suitableAges: [3, 8] },
  { id: 'being-patient', name: { en: 'Learning to Be Patient', de: 'Geduld lernen', fr: 'Apprendre la patience', it: 'Imparare la pazienza' }, emoji: '🐢', ageGroup: 'preschool', suitableAges: [3, 7] },
  ...
  // Pre-Teen (9-12 years)
  { id: 'money-saving', name: { en: 'Saving Money', de: 'Geld sparen', fr: 'Économiser de l\'argent', it: 'Risparmiare denaro' }, emoji: '💰', ageGroup: 'preteen', suitableAges: [6, 12] },
  { id: 'spending-wisely', name: { en: 'Spending Wisely', de: 'Klug ausgeben', fr: 'Dépenser intelligemment', it: 'Spendere con saggezza' }, emoji: '🛒', ageGroup: 'preteen', suitableAges: [7, 12] },
  { id: 'screen-time', name: { en: 'Screen Time Balance', de: 'Bildschirmzeit-Balance', fr: 'Équilibre du temps d\'écran', it: 'Equilibrio con lo schermo' }, emoji: '📱', ageGroup: 'preteen', suitableAges: [5, 12] },
  { id: 'peer-pressure', name: { en: 'Peer Pressure', de: 'Gruppenzwang', fr: 'Pression des pairs', it: 'Pressione dei coetanei' }, emoji: '👥', ageGroup: 'preteen', suitableAges: [8, 12] },
  { id: 'body-changes', name: { en: 'Body Changes', de: 'Körperliche Veränderungen', fr: 'Changements corporels', it: 'Cambiamenti del corpo' }, emoji: '🌱', ageGroup: 'preteen', suitableAges: [9, 12] },
