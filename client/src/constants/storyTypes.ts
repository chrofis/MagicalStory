...
export const historicalEvents: HistoricalEvent[] = [
  ...
  { id: 'moon-landing', name: { en: 'First Moon Landing', de: 'Erste Mondlandung', fr: 'Premier pas sur la Lune' }, shortName: { en: 'Moon Landing', de: 'Mondlandung', fr: 'Alunissage' }, emoji: '🌙', year: 1969, category: 'exploration' },
  { id: 'columbus-voyage', name: { en: 'Columbus Reaches the Americas', de: 'Kolumbus erreicht Amerika', fr: 'Colomb atteint les Amériques' }, shortName: { en: 'Discovery of America', de: 'Entdeckung Amerikas', fr: 'Découverte de l\'Amérique' }, emoji: '⛵', year: 1492, category: 'exploration' },
  { id: 'wright-brothers', name: { en: 'First Powered Flight', de: 'Erster Motorflug', fr: 'Premier vol motorisé' }, shortName: { en: 'First Flight', de: 'Erster Flug', fr: 'Premier vol' }, emoji: '✈️', year: 1903, category: 'exploration' },
  { id: 'lindbergh-flight', name: { en: 'First Solo Atlantic Crossing', de: 'Erster Atlantik-Soloflug', fr: 'Première traversée solitaire' }, shortName: { en: 'Atlantic Flight', de: 'Atlantikflug', fr: 'Vol Atlantique' }, emoji: '🛩️', year: 1927, category: 'exploration' },
  { id: 'everest-summit', name: { en: 'First Everest Summit', de: 'Erste Everest-Besteigung', fr: 'Premier sommet de l\'Everest' }, shortName: { en: 'Climbing Everest', de: 'Everest-Besteigung', fr: 'Ascension Everest' }, emoji: '🏔️', year: 1953, category: 'exploration' },
  { id: 'south-pole', name: { en: 'First to the South Pole', de: 'Erster am Südpol', fr: 'Premier au Pôle Sud' }, shortName: { en: 'South Pole', de: 'Südpol', fr: 'Pôle Sud' }, emoji: '❄️', year: 1911, category: 'exploration' },
  { id: 'magellan-circumnavigation', name: { en: 'First Circumnavigation', de: 'Erste Weltumsegelung', fr: 'Premier tour du monde' }, shortName: { en: 'Around the World', de: 'Weltumsegelung', fr: 'Tour du monde' }, emoji: '🌍', year: 1522, category: 'exploration' },
  { id: 'mariana-trench', name: { en: 'Deepest Ocean Dive', de: 'Tiefster Meerstauchgang', fr: 'Plongée la plus profonde' }, shortName: { en: 'Deep Sea Dive', de: 'Tiefseetauchen', fr: 'Plongée profonde' }, emoji: '🌊', year: 1960, category: 'exploration' },

  // Science & Medicine
  { id: 'electricity-discovery', name: { en: 'Franklin\'s Kite Experiment', de: 'Franklins Drachenexperiment', fr: 'Expérience du cerf-volant' }, shortName: { en: 'Electricity Discovery', de: 'Elektrizität entdeckt', fr: 'Découverte électricité' }, emoji: '⚡', year: 1752, category: 'science' },
  { id: 'penicillin', name: { en: 'Discovery of Penicillin', de: 'Entdeckung des Penicillins', fr: 'Découverte de la pénicilline' }, shortName: { en: 'Penicillin', de: 'Penicillin', fr: 'Pénicilline' }, emoji: '💊', year: 1928, category: 'science' },
  { id: 'vaccine-discovery', name: { en: 'First Vaccine', de: 'Erste Impfung', fr: 'Premier vaccin' }, shortName: { en: 'First Vaccine', de: 'Erste Impfung', fr: 'Premier vaccin' }, emoji: '💉', year: 1796, category: 'science' },
  { id: 'dna-discovery', name: { en: 'DNA Structure Discovered', de: 'DNA-Struktur entdeckt', fr: 'Structure ADN découverte' }, shortName: { en: 'DNA Discovery', de: 'DNA-Entdeckung', fr: 'Découverte ADN' }, emoji: '🧬', year: 1953, category: 'science' },
  { id: 'dinosaur-discovery', name: { en: 'First Dinosaur Named', de: 'Erster Dinosaurier benannt', fr: 'Premier dinosaure nommé' }, shortName: { en: 'Dinosaur Discovery', de: 'Dinosaurier-Entdeckung', fr: 'Découverte dinosaure' }, emoji: '🦕', year: 1824, category: 'science' },
  { id: 'einstein-relativity', name: { en: 'Einstein\'s Relativity', de: 'Einsteins Relativitätstheorie', fr: 'Relativité d\'Einstein' }, shortName: { en: 'Einstein\'s Theory', de: 'Einsteins Theorie', fr: 'Théorie d\'Einstein' }, emoji: '🧠', year: 1905, category: 'science' },
  { id: 'galapagos-darwin', name: { en: 'Darwin Visits Galápagos', de: 'Darwin auf Galápagos', fr: 'Darwin aux Galápagos' }, shortName: { en: 'Darwin\'s Voyage', de: 'Darwins Reise', fr: 'Voyage de Darwin' }, emoji: '🐢', year: 1835, category: 'science' },
  { id: 'first-heart-transplant', name: { en: 'First Heart Transplant', de: 'Erste Herztransplantation', fr: 'Première greffe cardiaque' }, shortName: { en: 'Heart Transplant', de: 'Herztransplantation', fr: 'Greffe cardiaque' }, emoji: '❤️', year: 1967, category: 'science' },
  ...
  // Inventions
  { id: 'telephone-invention', name: { en: 'First Telephone Call', de: 'Erster Telefonanruf', fr: 'Premier appel téléphonique' }, shortName: { en: 'Telephone', de: 'Telefon', fr: 'Téléphone' }, emoji: '📞', year: 1876, category: 'invention' },
  { id: 'light-bulb', name: { en: 'Edison\'s Light Bulb', de: 'Edisons Glühbirne', fr: 'Ampoule d\'Edison' }, shortName: { en: 'Light Bulb', de: 'Glühbirne', fr: 'Ampoule' }, emoji: '💡', year: 1879, category: 'invention' },
  { id: 'printing-press', name: { en: 'Gutenberg\'s Printing Press', de: 'Gutenbergs Buchdruck', fr: 'Presse de Gutenberg' }, shortName: { en: 'Printing Press', de: 'Buchdruck', fr: 'Imprimerie' }, emoji: '📖', year: 1440, category: 'invention' },
  { id: 'internet-creation', name: { en: 'Birth of the World Wide Web', de: 'Geburt des World Wide Web', fr: 'Naissance du Web' }, shortName: { en: 'The Web', de: 'Das Internet', fr: 'Le Web' }, emoji: '🌐', year: 1991, category: 'invention' },

  // Human Rights & Freedom
  { id: 'emancipation', name: { en: 'Abolition of Slavery', de: 'Abschaffung der Sklaverei', fr: 'Abolition de l\'esclavage' }, shortName: { en: 'End of Slavery', de: 'Ende der Sklaverei', fr: 'Fin de l\'esclavage' }, emoji: '⛓️', year: 1865, category: 'rights' },
  ...
  { id: 'rosa-parks', name: { en: 'Rosa Parks & Bus Boycott', de: 'Rosa Parks & Busboykott', fr: 'Rosa Parks & Boycott des bus' }, shortName: { en: 'Rosa Parks', de: 'Rosa Parks', fr: 'Rosa Parks' }, emoji: '🚌', year: 1955, category: 'rights' },
  ...
  { id: 'mandela-freedom', name: { en: 'Mandela Released', de: 'Mandela befreit', fr: 'Mandela libéré' }, shortName: { en: 'Mandela Free', de: 'Mandela frei', fr: 'Mandela libre' }, emoji: '✊', year: 1990, category: 'rights' },
  ...
  { id: 'eiffel-tower', name: { en: 'Eiffel Tower Opens', de: 'Eiffelturm eröffnet', fr: 'Tour Eiffel inaugurée' }, shortName: { en: 'Eiffel Tower', de: 'Eiffelturm', fr: 'Tour Eiffel' }, emoji: '🗼', year: 1889, category: 'construction' },
  ...
  { id: 'disneyland-opening', name: { en: 'Disneyland Opens', de: 'Disneyland eröffnet', fr: 'Disneyland ouvre' }, shortName: { en: 'Disneyland', de: 'Disneyland', fr: 'Disneyland' }, emoji: '🏰', year: 1955, category: 'culture' },
  { id: 'first-movie', name: { en: 'Birth of Cinema', de: 'Geburt des Kinos', fr: 'Naissance du cinéma' }, shortName: { en: 'First Movies', de: 'Erste Filme', fr: 'Premiers films' }, emoji: '🎬', year: 1895, category: 'culture' },
  ...
  { id: 'king-tut', name: { en: 'King Tut\'s Tomb Discovered', de: 'Tutanchamuns Grab entdeckt', fr: 'Tombeau de Toutânkhamon' }, shortName: { en: 'King Tut', de: 'Tutanchamun', fr: 'Toutânkhamon' }, emoji: '👑', year: 1922, category: 'archaeology' },
