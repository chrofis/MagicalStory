...
export const occasions: OccasionData[] = [
  // 1. Birthday
  {
    id: 'geburtstag',
    emoji: '🎂',
    name: { en: 'Birthday', de: 'Geburtstag', fr: 'Anniversaire' },
    title: {
  ...
  // 2. Christmas
  {
    id: 'weihnachten',
    emoji: '🎄',
    name: { en: 'Christmas', de: 'Weihnachten', fr: 'Noël' },
    title: {
    ...
    faq: [
      {
        q: { en: 'Will the story have a Christmas theme?', de: 'Hat die Geschichte ein Weihnachtsthema?', fr: 'L\'histoire aura-t-elle un thème de Noël ?' },
        a: { en: 'If you select the Christmas theme, absolutely! But you can also pick any other theme — the story itself is the gift.', de: 'Wenn du das Weihnachtsthema wählst, auf jeden Fall! Du kannst aber auch jedes andere Thema wählen — die Geschichte selbst ist das Geschenk.', fr: 'Si vous choisissez le thème Noël, absolument ! Mais vous pouvez aussi choisir n\'importe quel autre thème — l\'histoire elle-même est le cadeau.' },
      },
      {
        q: { en: 'Can I order multiple books for siblings?', de: 'Kann ich mehrere Bücher für Geschwister bestellen?', fr: 'Puis-je commander plusieurs livres pour des frères et soeurs ?' },
        a: { en: 'Yes! Create a unique story for each child, or create one story with all siblings as characters.', de: 'Ja! Erstelle eine einzigartige Geschichte für jedes Kind oder eine Geschichte mit allen Geschwistern als Charaktere.', fr: 'Oui ! Créez une histoire unique pour chaque enfant, ou une histoire avec tous les frères et soeurs comme personnages.' },
      },
    ],
  },
  ...
  // 3. Easter
  {
    id: 'ostern',
    emoji: '🐰',
    name: { en: 'Easter', de: 'Ostern', fr: 'Pâques' },
    title: {
  ...
  // 4. Baptism / Christening
  {
    id: 'taufe',
    emoji: '💧',
    name: { en: 'Baptism', de: 'Taufe', fr: 'Baptême' },
    title: {
  ...
  // 5. First Day of School (Einschulung)
  {
    id: 'einschulung',
    emoji: '🎒',
    name: { en: 'First Day of School', de: 'Einschulung', fr: 'Rentrée scolaire' },
    title: {
    ...
    faq: [
      {
        q: { en: 'What age is Einschulung typically?', de: 'In welchem Alter ist die Einschulung?', fr: 'À quel âge a lieu la rentrée scolaire ?' },
        a: { en: 'In Switzerland, children typically start school (Kindergarten or 1st grade) at age 4-6. Our stories adapt the language to the child\'s age.', de: 'In der Schweiz kommen Kinder typischerweise mit 4-6 Jahren in den Kindergarten oder die 1. Klasse. Unsere Geschichten passen die Sprache an das Alter des Kindes an.', fr: 'En Suisse, les enfants commencent généralement l\'école (jardin d\'enfants ou 1ère année) à 4-6 ans. Nos histoires adaptent le langage à l\'âge de l\'enfant.' },
      },
      {
        q: { en: 'Does the story help with school anxiety?', de: 'Hilft die Geschichte bei Schulangst?', fr: 'L\'histoire aide-t-elle avec l\'anxiété scolaire ?' },
        a: { en: 'Yes! The "First Day of School" theme is specifically designed to address common fears and show your child that school is an exciting adventure.', de: 'Ja! Das Thema "Erster Schultag" ist speziell darauf ausgelegt, häufige Ängste anzusprechen und deinem Kind zu zeigen, dass Schule ein spannendes Abenteuer ist.', fr: 'Oui ! Le thème "Premier jour d\'école" est spécialement conçu pour aborder les peurs courantes et montrer à votre enfant que l\'école est une aventure passionnante.' },
      },
    ],
  },
  ...
  // 6. New Sibling
  {
    id: 'geschwisterchen',
    emoji: '👶',
    name: { en: 'New Sibling', de: 'Geschwisterchen', fr: 'Nouveau bébé' },
    title: {
  ...
  // 7. Mother's Day
  {
    id: 'muttertag',
    emoji: '💐',
    name: { en: 'Mother\'s Day', de: 'Muttertag', fr: 'Fête des mères' },
    title: {
    ...
    faq: [
      {
        q: { en: 'Can the child create the story themselves?', de: 'Kann das Kind die Geschichte selbst erstellen?', fr: 'L\'enfant peut-il créer l\'histoire lui-même ?' },
        a: { en: 'Older children (6+) can navigate the wizard with minimal help. For younger children, a parent or grandparent can guide them through the process.', de: 'Ältere Kinder (6+) können den Assistenten mit minimaler Hilfe bedienen. Für jüngere Kinder können Eltern oder Grosseltern sie durch den Prozess führen.', fr: 'Les enfants plus âgés (6+) peuvent utiliser l\'assistant avec un minimum d\'aide. Pour les plus jeunes, un parent ou grand-parent peut les guider.' },
      },
      {
        q: { en: 'Can I add mom as a character?', de: 'Kann ich Mama als Charakter hinzufügen?', fr: 'Puis-je ajouter maman comme personnage ?' },
        a: { en: 'Yes! Add mom as a second character with her name and description. She\'ll appear in the story alongside your child.', de: 'Ja! Füge Mama als zweiten Charakter mit ihrem Namen und Beschreibung hinzu. Sie erscheint in der Geschichte neben deinem Kind.', fr: 'Oui ! Ajoutez maman comme deuxième personnage avec son nom et sa description. Elle apparaîtra dans l\'histoire aux côtés de votre enfant.' },
      },
    ],
  },
  ...
  // 8. Father's Day
  {
    id: 'vatertag',
    emoji: '👔',
    name: { en: 'Father\'s Day', de: 'Vatertag', fr: 'Fête des pères' },
    title: {
    ...
    faq: [
      {
        q: { en: 'Can dad be a character in the story?', de: 'Kann Papa ein Charakter in der Geschichte sein?', fr: 'Papa peut-il être un personnage de l\'histoire ?' },
        a: { en: 'Absolutely! Add dad as a second character. He\'ll appear alongside your child as an adventure partner.', de: 'Auf jeden Fall! Füge Papa als zweiten Charakter hinzu. Er erscheint als Abenteuer-Partner neben deinem Kind.', fr: 'Absolument ! Ajoutez papa comme deuxième personnage. Il apparaîtra aux côtés de votre enfant comme partenaire d\'aventure.' },
      },
      {
        q: { en: 'Is this just for young children?', de: 'Ist das nur für kleine Kinder?', fr: 'Est-ce seulement pour les petits enfants ?' },
        a: { en: 'Not at all! The AI adapts the story complexity to the child\'s age. A 10-year-old will get a more sophisticated story than a 3-year-old.', de: 'Ganz und gar nicht! Die KI passt die Komplexität der Geschichte an das Alter des Kindes an. Ein 10-Jähriger bekommt eine anspruchsvollere Geschichte als ein 3-Jähriger.', fr: 'Pas du tout ! L\'IA adapte la complexité de l\'histoire à l\'âge de l\'enfant. Un enfant de 10 ans aura une histoire plus élaborée qu\'un enfant de 3 ans.' },
      },
    ],
  },
  ...
  // 9. St. Nicholas Day
  {
    id: 'nikolaus',
    emoji: '🎅',
    name: { en: 'St. Nicholas Day', de: 'Nikolaustag', fr: 'Saint-Nicolas' },
    title: {
  ...
  // 10. Advent
  {
    id: 'advent',
    emoji: '🕯️',
    name: { en: 'Advent', de: 'Advent', fr: 'Avent' },
    title: {
    ...
    faq: [
      {
        q: { en: 'How many pages does the story have?', de: 'Wie viele Seiten hat die Geschichte?', fr: 'Combien de pages compte l\'histoire ?' },
      ...
      {
        q: { en: 'Can I use this in an Advent calendar?', de: 'Kann ich das in einem Adventskalender verwenden?', fr: 'Puis-je l\'utiliser dans un calendrier de l\'Avent ?' },
  ...
  // 11. Moving House
  {
    id: 'umzug',
    emoji: '🏠',
    name: { en: 'Moving House', de: 'Umzug', fr: 'Déménagement' },
    title: {
  ...
  // 12. Starting Kindergarten
  {
    ...
    emoji: '🧒',
    name: { en: 'Starting Kindergarten', de: 'Kindergartenstart', fr: 'Entrée en maternelle' },
    title: {
    ...
    faq: [
      ...
      {
        q: { en: 'Can I customize the kindergarten name in the story?', de: 'Kann ich den Kindergarten-Namen in der Geschichte anpassen?', fr: 'Puis-je personnaliser le nom de la maternelle dans l\'histoire ?' },
        a: { en: 'You can add custom details like the kindergarten name or teacher\'s name to make the story even more personal and recognizable for your child.', de: 'Du kannst individuelle Details wie den Kindergarten-Namen oder den Namen der Lehrperson hinzufügen, damit die Geschichte für dein Kind noch persönlicher und wiedererkennbarer wird.', fr: 'Vous pouvez ajouter des détails personnalisés comme le nom de la maternelle ou de l\'enseignant pour rendre l\'histoire encore plus personnelle.' },
      },
    ],
  },
];
