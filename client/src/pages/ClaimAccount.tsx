...
const translations = {
  ...
  de: {
    brand: 'Magical Story',
    loading: 'Dein Link wird ueberprueft...',
    ...
    invalidTitle: 'Ungueltiger oder abgelaufener Link',
    invalidDesc: 'Dieser Link ist ungueltig oder abgelaufen. Du kannst dich trotzdem anmelden, wenn du ein Passwort hast.',
  ...
  fr: {
    ...
    setPassword: 'Definissez un mot de passe pour securiser votre compte.',
    password: 'Nouveau mot de passe',
    confirmPassword: 'Confirmer le mot de passe',
    submit: 'Definir le mot de passe et se connecter',
    ...
    invalidTitle: 'Lien invalide ou expire',
    invalidDesc: 'Ce lien est invalide ou a expire. Vous pouvez toujours vous connecter si vous avez un mot de passe.',
    goToLogin: 'Aller a la connexion',
    successTitle: 'Compte revendique !',
    successDesc: 'Vous etes maintenant connecte. Redirection vers vos histoires...',
