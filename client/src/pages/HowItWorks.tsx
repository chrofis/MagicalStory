...
const translations = {
  ...
  it: {
    ...
    step2Title: 'Descrivi la tua storia',
    step2Desc: 'Scegli tra oltre 170 temi o descrivi la tua idea: il primo giorno di scuola, un dentino caduto, un drago in giardino. La storia nasce intorno a questo.',
    step3Title: 'L\'IA scrive e illustra',
    step3Desc: 'Una storia originale con illustrazioni coerenti nello stile artistico che scegli, in tedesco, inglese o francese, al livello di lettura di tuo figlio.',
    step4Title: 'Modifica finché è giusta',
    step4Desc: 'Riscrivi qualsiasi frase, rigenera qualsiasi illustrazione, correggi un singolo personaggio su una singola pagina. Poi leggila sullo schermo o ordinala stampata.',
    faqTitle: 'Domande sulla creazione di un libro',
    faq1Q: 'Posso scrivere la mia storia o devo scegliere tra modelli?',
    faq1A: 'Descrivi la storia che vuoi e l\'IA la scrive. I temi sono punti di partenza, non testi fissi: due libri sullo stesso tema diventano due storie diverse. Puoi anche modificare ogni frase in seguito.',
    faq2Q: 'Che cosa fa esattamente l\'IA?',
    faq2A: 'Scrive il testo e genera tutte le illustrazioni. La foto che carichi serve a mantenere coerente l\'aspetto di ogni personaggio su tutte le pagine, non viene incollata nel libro.',
    ...
    faq4Q: 'Quanto costa?',
    faq4A: 'La prima storia è gratuita e non serve un account. Dopo, il libro digitale costa CHF 9.90 e il cartonato stampato da CHF 33 a 48.',
    ...
    // Sections
    s1Title: 'Modifica ogni parola',
    s1Desc: 'Ogni pagina di testo è completamente modificabile. Cambia i nomi, riscrivi le frasi, adatta la storia alla tua famiglia. L\'IA scrive la prima stesura — tu la rendi tua.',
    s1b1: 'Clicca su un testo qualsiasi per modificarlo direttamente',
    s1b2: 'Riscrivi interi paragrafi o correggi singole parole',
    s1b3: 'Adatta il livello di lettura all\'età di tuo figlio',
    s2Title: 'Dai forma a ogni immagine',
    s2Desc: 'Non ti piace come è venuta una scena? Descrivi che cosa vuoi cambiare e in pochi secondi nasce una nuova illustrazione. Cambia l\'ambientazione, sposta i personaggi o prova una scena completamente diversa.',
    s2b1: 'Descrivi le modifiche con parole tue — «cielo più azzurro» o «aggiungi un arcobaleno»',
    s2b2: 'Reinventa intere scene con una nuova descrizione',
    s2b3: 'Rigenera una pagina finché non è perfetta',
    s3Title: 'Personaggi coerenti',
    s3Desc: 'Carica una foto una volta sola e tuo figlio appare uguale in tutto il libro. Se un personaggio non convince su una pagina, correggi solo quella pagina senza toccare le altre.',
    s3b1: 'L\'IA mantiene l\'aspetto dei personaggi su tutte le pagine',
    s3b2: 'Correggi singoli personaggi su pagine specifiche',
    s3b3: 'Aggiungi fino a 10 familiari come personaggi',
    s4Title: 'Oltre 170 temi',
    s4Desc: 'Dalle avventure dei pirati alle storie sul primo giorno di scuola. Ogni tema è pensato con un linguaggio adatto all\'età e trame coinvolgenti.',
    s4b1: 'Avventura, fantasia, compleanno, storie della buonanotte',
    s4b2: 'Sfide quotidiane: un fratellino in arrivo, la visita dal dentista, superare le paure',
    s4b3: 'Storie locali: città svizzere, luoghi simbolo e tradizioni',
    s5Title: '8 stili artistici',
    s5Desc: 'Scegli tra 3D in stile Pixar, acquerello, fumetto, anime, realistico e altri ancora. Ogni stile viene applicato in modo coerente a tutte le pagine.',
    ctaTitle: 'Provala gratis — la prima storia non costa nulla',
    ctaDesc: 'Carica una foto, scegli un tema e vedi il tuo libro personalizzato in meno di 3 minuti. Senza account.',
    ctaButton: 'Crea la tua storia',
  },
};
