...
const aboutContent: Record<string, {
  ...
  en: {
    ...
    scienceText: [
      'In the story, your child is the hero — brave, honest, kind. And when they look in the mirror, they see that same hero looking back — and know they can do it in real life too.',
      'That belief is the real gift. Long after the last page, when your child faces the first day of school or a hard right thing to do, they meet it already sure of who they are.',
  ...
  de: {
    ...
    scienceText: [
      'In der Geschichte ist dein Kind der Held — mutig, ehrlich, freundlich. Und wenn es danach in den Spiegel schaut, sieht es genau diesen Helden zurückblicken — und weiss, dass es das auch im echten Leben kann.',
      'Dieser Glaube ist das eigentliche Geschenk. Lange nach der letzten Seite — beim ersten Schultag oder wenn es schwer ist, das Richtige zu tun — weiss dein Kind schon, wer es ist.',
