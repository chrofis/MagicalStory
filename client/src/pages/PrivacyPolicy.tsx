    ...
    sections: [
      {
        ...
        content: `Magical Story ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, process, and protect your personal data when you use our AI-powered personalized storybook service.
...
• We do not store full credit card numbers`
      ...
      {
        title: '4. How We Use Your Photos',
        content: `This is important: Your photos are processed as follows:
...
• Legal Obligation: For tax records and legal compliance`
      },
      {
        ...
        content: `Our service may be used to create stories featuring children. We take special care with this data:
...
To exercise these rights, contact us at privacy@magicalstory.com or use the account settings in our app.`
      },
      {
...
Für DSGVO-Zwecke sind wir der Verantwortliche für die von uns verarbeiteten personenbezogenen Daten.`
      },
      {
        ...
        content: `Wir erfassen und verarbeiten folgende Arten von Daten:
...
• Wir speichern keine vollständigen Kreditkartennummern`
      ...
      {
        title: '4. Wie wir Ihre Fotos verwenden',
        content: `Dies ist wichtig: Ihre Fotos werden wie folgt verarbeitet:
...
5. Keine Weitergabe an Dritte: Ihre Fotos werden niemals zu Marketing- oder anderen Zwecken an Dritte weitergegeben. Sie werden nur von unseren KI-Systemen und Cloud-Infrastrukturanbietern verarbeitet (unter strengen Datenverarbeitungsvereinbarungen).`
      },
      {
        title: '5. Rechtsgrundlage für die Verarbeitung (DSGVO)',
        content: `Wir verarbeiten Ihre personenbezogenen Daten auf Basis von:
...
• Rechtliche Verpflichtung: Für Steuerunterlagen und rechtliche Compliance`
      },
      {
        title: '6. Datenschutz für Kinder',
        content: `Unser Service kann zur Erstellung von Geschichten mit Kindern verwendet werden. Wir gehen besonders sorgfältig mit diesen Daten um:
...
• Incident Response: Dokumentierte Verfahren für den Umgang mit Datenschutzverletzungen`
      },
      {
        ...
        content: `Wir teilen Daten nur mit:
...
Wir können Daten offenlegen, wenn dies gesetzlich vorgeschrieben ist, durch Gerichtsbeschluss oder zum Schutz unserer Rechte.`
      },
      {
        title: '9. Internationale Datenübertragungen',
        content: `Ihre Daten können verarbeitet werden in:
• Schweiz (primär)
• Europäische Union
...
• Geeignete Garantien gemäß DSGVO`
      },
      {
        ...
        content: `Nach DSGVO und anwendbaren Gesetzen haben Sie das Recht auf:
...
Um diese Rechte auszuüben, kontaktieren Sie uns unter privacy@magicalstory.com oder nutzen Sie die Kontoeinstellungen in unserer App.`
      },
      {
        title: '11. Datenspeicherung',
        content: `Wir speichern Daten für folgende Zeiträume:
...
Sie können Ihr Konto und alle zugehörigen Daten jederzeit über die Kontoeinstellungen löschen.`
      },
      {
        title: '12. Cookies und Tracking',
        content: `Wir verwenden:
...
Wir verwenden keine Werbe-Cookies oder Tracking-Pixel.`
      },
      {
...
Die fortgesetzte Nutzung nach Änderungen gilt als Annahme der aktualisierten Richtlinie.`
      ...
      {
        title: '14. Kontakt & Beschwerden',
        content: `Bei Datenschutzfragen oder zur Ausübung Ihrer Rechte:
...
Pour exercer ces droits, contactez-nous à privacy@magicalstory.com ou utilisez les paramètres du compte dans notre application.`
      },
      {
...
Nous n'utilisons pas de cookies publicitaires ou de pixels de suivi.`
      },
      {
