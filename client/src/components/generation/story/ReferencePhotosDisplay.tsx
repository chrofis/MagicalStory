...
// NOTE: per-version debug data (grokRefImages sent to the model, composite-cover
// 2-pass attempts) is deliberately NOT displayed here anymore — the version
// viewer (ImageHistoryModal, "Bild wählen") is the one canonical home for
// per-version data. This component shows page-level generation inputs only.
