...
const footerTexts = {
  ...
  it: {
    createHeading: 'Creare',
    create: 'Creare un libro con l\'IA',
    guides: 'Guide',
    themes: 'Temi',
    pricing: 'Prezzi',
    tryFree: 'Prova gratis',
    discoverHeading: 'Scoprire',
    cities: 'Città svizzere',
    occasions: 'Occasioni',
    gifts: 'Idee regalo',
    science: 'La ricerca',
    compareHeading: 'Confrontare',
    comparisons: 'Tutti i confronti',
    aiGenerators: 'Migliori generatori IA',
    personalised: 'Migliori libri personalizzati',
    ...
    privacy: 'Privacy',
    imprint: 'Impressum',
    tagline: 'La storia del tuo bambino — scritta e illustrata dall\'IA, poi modificabile da te.',
    copyright: 'Magical Story. Tutti i diritti riservati.',
  },
};
