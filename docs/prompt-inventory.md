...
| story-beats-review.txt | storyHelpers.js `buildBeatsReviewPrompt` | LAB ONLY (2026-09-01): the old beats reviewer, replayed by beats_review_replay / beats_scenes. Production runs no beats review |
...
| story-beats-audit.txt | storyHelpers.js `buildBeatsAuditPrompt` | LAB ONLY (2026-09-01): blind beats audit, replayed by audit_replay level=beats. Production runs no beats audit |
